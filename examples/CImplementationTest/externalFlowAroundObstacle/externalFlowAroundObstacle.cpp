...
#include "palabos3DInC.h"
#include "palabos3DInC.hh"
...
void runProgram()
{
    ...
    /// use the C style external collide and stream
    DescriptorInC D3Q19CStyle = constructD3Q19Descriptor();
    DynamicsInC BGKCStyle;
    constructBGKDynamics(&BGKCStyle, &D3Q19CStyle, param.omega);
    integrateProcessingFunctional(
            new ExternalRhoJcollideAndStream3DInC<T,DESCRIPTOR>(BGKCStyle),
